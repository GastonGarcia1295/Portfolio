...
### 🌿 Bienestar Interior
Landing page de alta conversión para venta de E-Book de salud digestiva.

- Contador regresivo de urgencia real
- Sticky CTA optimizado para mobile
- Integración directa con **Mercado Pago**
- Precio visible sin necesidad de scrollear

🔗 [bienestarinterior.netlify.app](https://bienestarinterior.netlify.app)

---

### ✅ Confirmación de Compra
Página de entrega automática de activo digital post-pago.

- Integrada como URL de retorno en Mercado Pago
- Entrega inmediata del producto digital sin intervención manual
- Instrucciones claras para el comprador

🔗 [Ver proyecto](https://gastongarcia1295.github.io/Intestino-Descarga/)

---

### 📊 Sistema de Gestión Admin
Panel administrativo interactivo para registro de ventas y gestión de clientes.

- Dashboard con métricas en tiempo real
- Gráficos dinámicos con Chart.js
- Registro de operaciones y seguimiento de clientes

🔗 [Ver proyecto](https://gastongarcia1295.github.io/Gestion-Ventas/)

---

### 🧮 Calculadora de Presupuesto
Cotizador interactivo para proyectos de desarrollo web.

- Conversión ARS/USD en tiempo real vía API
- Múltiples tipos de proyecto y opciones configurables
- Exportación del presupuesto completo en **PDF**

🔗 [Ver proyecto](https://gastongarcia1295.github.io/Calculadora-Presupuesto/)

---

### 👗 Magnolia Store
Tienda de moda femenina premium con experiencia de compra completa.

- Carrito de compras funcional
- Modal de producto con galería y zoom
- Filtros por categoría
- Cuotas automáticas e integración con **Mercado Pago**

🔗 [magnoliashop.netlify.app](https://magnoliashop.netlify.app)
...
### 📱 Tech Store Shop
Landing page premium para tienda de iPhones y accesorios Apple.

- Canvas de partículas animado en el fondo
...
- 🎨 **Fondo animado** con símbolos del mundo dev flotando en Canvas
- 🎠 **Carrusel 3D** de proyectos — navegable con rueda del mouse, swipe y teclado
...
- **Email** — [gastongarcia1295@gmail.com](mailto:gastongarcia1295@gmail.com)
- **WhatsApp** — [Iniciar conversación](https://wa.me/5491168087692?text=Hola%20Gast%C3%B3n%2C%20quisiera%20conversar%20para%20iniciar%20un%20proyecto)

---

<div align="center">
  <sub>Desarrollado por <strong>Gastón García</strong> — Castelar, Buenos Aires · 2026</sub>
</div>
